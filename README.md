...
- First, you need to have Node.js, npm and Hardhat installed, then clone the project via HTTPS through this command:
...
- Once being inside the directory, download and install the dependencies using:
    `npm i`
